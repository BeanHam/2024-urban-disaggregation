...
def get_geodata(root, 
    ...
    ## save  
    geodata.to_csv(f'D:/disaggregation-data/911-call/geodata/{data_name}.csv',header=True)
    np.save(f'D:/disaggregation-data/911-call/adjacencies/{data_name}-geo.npy', geo_A)
    np.save(f'D:/disaggregation-data/911-call/adjacencies/{data_name}-distance.npy', distance_A)
    np.save(f'D:/disaggregation-data/911-call/adjacencies/{data_name}-border.npy', border_A)
...
def get_linkage(low_res_geodata, 
    ...
    np.save(f'D:/disaggregation-data/911-call/linkages/{linkage_name}.npy', linkage)
...
def get_attributes(parameters,
    ...
    ## save data
    np.save(f'D:/disaggregation-data/911-call/attributes/puma.npy', X_puma)
    np.save(f'D:/disaggregation-data/911-call/attributes/nta.npy', X_nta)
    np.save(f'D:/disaggregation-data/911-call/attributes/tract.npy', X_tract)
    np.save(f'D:/disaggregation-data/911-call/attributes/block.npy', X_block)
    np.save(f'D:/disaggregation-data/911-call/attributes/extreme.npy', X_extreme)
