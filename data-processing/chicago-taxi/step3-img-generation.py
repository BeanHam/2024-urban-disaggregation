...
root = 'D:/disaggregation-data/chicago-taxi/'
...
def main():
    ...
    # load geodatas
    #--------------------
    geodata_community, att_community = load_geodata_attributes('community')
    ...
    # parameters
    #--------------------
    geodatas = [geodata_community, geodata_tract, geodata_block, geodata_extreme]
    atts = [att_community, att_tract, att_block, att_extreme]
    names = ['community', 'tract', 'block', 'extreme']
    img_size = (128,256)
    fig_size = (1.28,2.56)
