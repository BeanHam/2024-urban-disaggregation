...
#
    ...
    ## save  
    geodata.to_csv(f'D:/disaggregation-data/taxi/geodata/{data_name}.csv',header=True)
    #np.save(f'D:/disaggregation-data/taxi/adjacencies/{data_name}-geo.npy', geo_A)
    #np.save(f'D:/disaggregation-data/taxi/adjacencies/{data_name}-distance.npy', distance_A)
    #np.save(f'D:/disaggregation-data/taxi/adjacencies/{data_name}-border.npy', border_A)
...
def get_linkage(low_res_geodata, 
    ...
    np.save(f'D:/disaggregation-data/taxi/linkages/{linkage_name}.npy', linkage)
